...
%
% Technical questions _only_ tob
...
Nigel R. Shadbolt, Daniel A. Smith, Elena Simperl, Max Van Kleek, Yang Yang, \\ Wendy Hall\\
       ...
       \email{\{nrs,ds,es6g12,emax,yy1402,wh\}@ecs.soton.ac.uk}
}
...
\bibitem{bernerslee1999}
T.~Berners-Lee and M.~Fischetti.
\newblock {\em Weaving the web: The original design and ultimate destiny of the
  world wide web by its inventor}.
\newblock Harper, San Francisco, 1999.

\bibitem{chesbrough2003}
H.~Chesbrough.
\newblock {\em {Open innovation: The new imperative for creating and profiting
  from technology}}.
\newblock 2003.

\bibitem{grudin1994computer}
J.~Grudin.
\newblock Computer-supported cooperative work: History and focus.
\newblock {\em Computer}, 27(5):19--26, 1994.

\bibitem{howe2006crowdsourcing}
J.~Howe.
\newblock Crowdsourcing: A definition.
\newblock {\em Crowdsourcing: Tracking the rise of the amateur}, 2006.

\bibitem{kelly}
G.~A. Kelly.
\newblock {The Psychology Of Personal Constructs}.
\newblock 1955.

\bibitem{kuznetsov2006motivations}
S.~Kuznetsov.
\newblock Motivations of contributors to wikipedia.
\newblock {\em ACM SIGCAS computers and society}, 36(2):1, 2006.

\bibitem{lakhani2003hackers}
...
\bibitem{obamakieron}
K.~O'Hara.
\newblock {Social Machine Politics Are Here to Stay}.
\newblock {\em {IEEE Internet Computing}}, 17(2), March/April 2013.

\bibitem{parameswaran2007research}
M.~Parameswaran and A.~B. Whinston.
\newblock Research issues in social computing.
\newblock {\em Journal of the Association for Information Systems},
  8(6):336--350, 2007.

\bibitem{quinn2011human}
...
\bibitem{knowledgeelicitation}
N.~R. Shadbolt and A.~M. Burton.
\newblock {Knowledge Elicitation}.
\newblock {\em Evaluation of Human Work: Practical Ergonomics Methodology},
  1990.
