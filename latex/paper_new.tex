...
{\bf Tasks} \\
\hline
Task involves creative production or creation of content \\
...
The first set of constructs pertain to \emph{what} the participants do
individually and collectively within the system.  This task could
involve creation of content, subjective appraisal of content, posing
of problems, group solving of problems, and so on.  Tasks relate to a
pre-defined problem space or domain, or may be support a general,
broad collection of activities.  Finally, a question of whether a
direct benefit is derived by the platform/machine provider other than
the benefits gained by participants through participation.  
