...
\begin{table*}[htbp]
\begin{center}
\begin{tabular}{|p{6.5cm}|p{5.5cm}|p{4.5cm}|}
\hline
Designed Affordances & Participatory Affordances & Analytics \\
\hline
Does it afford anonymity & worked within them & Size \\
Does it afford quality control or moderation, and in what ways & worked around them & Maturity \\
What types of contribution does it afford & gamed them & Competitors \\
Openness of resulting data set & extended and enhanced them & Diversity of user base \\
 & derived new structures and conventions (e.g., hashtags) & Population over time \\
...
\begin{enumerate}
\item Roles emerging in the social machine.
   \indent In addition to designed and implemented roles such as {\it moderator} and {\it administrator}, emerging roles include motivations of the participant, such as {\it trolls}, {\it spammers}, {\it domain experts}, {\it social nexus}, and {\it re-blogger}.
\item Quality of contributions
    \indent For any social machine, the quality of contributions will vary. While some
...
\item Content of contributions
    \indent While a system operator may design their social machine to generate specific
